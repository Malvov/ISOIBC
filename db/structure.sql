...
CREATE INDEX index_maintenances_on_equipment_id ON maintenances USING btree (equipment_id);
...
CREATE INDEX index_maintenances_on_provider_id ON maintenances USING btree (provider_id);
...
ALTER TABLE ONLY maintenances
    ADD CONSTRAINT fk_rails_54a904b4b5 FOREIGN KEY (provider_id) REFERENCES providers(id);
...
ALTER TABLE ONLY maintenances
    ADD CONSTRAINT fk_rails_9bd119541d FOREIGN KEY (equipment_id) REFERENCES equipment(id);
