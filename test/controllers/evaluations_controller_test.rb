...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { employee_id: @evaluation.employee_id, result: @evaluation.result, task_id: @evaluation.task_id } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { employee_id: @evaluation.employee_id, result: @evaluation.result, task_id: @evaluation.task_id } }
